...
const Footer: React.FC = () => {
  return (
    <>
      <div className="bg-blue-500 w-full flex md:flex-row flex-col justify-around items-start p-0">
        <div className="p-5">
          <ul>
            <p className="text-white font-bold text-3xl pb-6">
              E<span className="text-black">Corner</span>
            </p>
      ...
      <div className="flex flex-col justify-center items-center text-center p-5 bg-blue-700">
        <h1 className="text-white font-semibold">
          © 2025 All rights reserved by ecorner
