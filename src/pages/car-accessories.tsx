...
export default function CarAccessoriesPage() {
  const [carAccessories, setCarAccessories] = useState<any[]>([]);
  ...
  useEffect(() => {
    const fetchCarAccessories = async () => {
      try {
        ...
        setCarAccessories(accessoriesData);
      } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-0 py-8">
        <h1 className="text-3xl font-bold text-center mb-8">Car Accessories</h1>
